...
// message is submitted lives in AthenaDepartureFlight, registered in the app
// slot, because submitting unmounts this screen.) On very short terminals
// the masthead drops to the wordmark line alone.
