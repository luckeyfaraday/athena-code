...
| 1d | The grand owl: full perched owl (tufts, brow, eyes, beak, folded wings, feathered chest, perch) joins the command room on terminals ≥42 rows; companion owl below that | `owlGrandLines` + `AthenaGrandOwl`; height gate in `home/athena-command-room.tsx` | none | done 2026-06-12 |
